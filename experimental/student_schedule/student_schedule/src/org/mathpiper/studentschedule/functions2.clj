...
"  
    ...
    (apply str (apply concat (for [row (range 0 288)]
      (apply concat
             
        
        (conj accumulator (str "<tr> <th nowrap>" row "</th>"))
      ...
      (apply concat
        ...
        (if (= startTime row)
          (do
                  ...
                  (conj accumulator (str "<td align=center rowspan=" duration " >" (name courseNumber) " " (name sectionNumber) "</td>"))
