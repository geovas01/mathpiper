 ...
 * level needed for the parser (they are parse time representations). Operator
 * entries contain information about the corresponding operator, such as
 * associativity, precedence, and type. Each instance of the operator entry is
 * bound to parser representations of its operands. Operator entries generate
 * the corresponding real Prolog operator objects and their real Prolog operand
 * <code>jTerms</code>.
 * 
...
abstract public class pOperatorEntry {
    ...
    /**
     * Determine if an unbound operator is not an error, or if it could be an
     * atom
     * 
    ...
    /**
     * Set the name of the library associated with this operator. Once an
     * association is made it is an error to change it (throws
     * <code>InvalidLibraryEntryException</code> in this case). Operators
     ...
     * generate syntax errors. Invokes internal <code>createOperator</code> to
     ...
     *            the input stream.
     * @param lhs
     *            A parsing packet (possibly null) representing the left
     *            operand. Used to generate the left hand <code>jTerm</code>.
     * @param rhs
     *            A parsing packet (possibly null) representing the right
     *            operand. Used to generate the right hand <code>jTerm</code>.
     * @param vars
    ...
    /**
     * The internal method for creating the <code>jTerm</code> representation of
     * this operator representation. Subclasses must override. The operands are
     * provided, already created.
     * 
     * @param l
     *            The left hand <code>jTerm</code>.
     * @param r
     *            The right hand <code>jTerm</code>.
     * 
     * @return <code>jTerm</code> representing this operator and its operands.
     */
