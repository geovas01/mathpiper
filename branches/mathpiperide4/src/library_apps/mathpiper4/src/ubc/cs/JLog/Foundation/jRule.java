...
/**
 * This class represents a rule of the form Head :- Base, where Head is a
 * predicate and Base is a term of predicates.
 * 
...
public class jRule implements iNameArity, iConsultable {
	...
	if (pg.rule_goal.unify(pg.input_goal, pg.unified)) {
	    ...
	    // this is required since the owning ruledefinitions may try more
	    // rules
	    // before returning control to the predicategoal which normally
	    // restores on failure.
    ...
    /**
     * Test if rule head will unify. Assumes predicate name and arity already
     * match.
     * 
