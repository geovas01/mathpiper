...
/**
 * This abstract class represents a simple graphical shape. A shape belongs to
 * an AnimationObject, and the position and rotation of this shape is given as
 * offset from position and rotation of the enclosing object.
 * 
...
abstract public class aAnimationShape extends aAttributeTranslation {
    ...
    /**
     * Draw the shape in the <code>Graphics</code> environment provided.
     * 
     * @param g
    ...
    /**
     * Sub-classes should return their type value (i.e., the value used to
     * specify the shape type to create in the animation&lt;addshape&gt;
     * predicate command).
     * 
    ...
    /**
     * Returns the bounding rectangle for this shape, given in global
     * coordinates.
     * 
     ...
     * 
     * @param x
     *            The new x position component, relative to enclosing object.
     * @param y
     *            The new y position component, relative to enclosing object.
     */
    ...
    /**
     * Set the object relative rotation of the shape to the given angle in
     * radians.
     * 
     * @param r
     *            The new angle of the shape in radians.
     */
	...
	setStringKeysForTranslation(t, OBJECT_ATTR_KEY, jObject.class,
		jObject.class);
    };
