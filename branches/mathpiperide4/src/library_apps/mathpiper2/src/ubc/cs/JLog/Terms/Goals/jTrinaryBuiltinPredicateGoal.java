...
/**
 * A very basic goal for trinary builtin predicates. It only attempts to prove
 * once (i.e., the retry fails). It calls the
 * prove(jTrinaryBuiltinPredicateGoal) method of the associated predicate to
 * perform the prove.
 * 
...
public class jTrinaryBuiltinPredicateGoal extends jGoal {
    ...
    public jTrinaryBuiltinPredicateGoal(jTrinaryBuiltinPredicate p, jTerm t1,
	    jTerm t2, jTerm t3) {
	predicate = p;
	term1 = t1;
	term2 = t2;
