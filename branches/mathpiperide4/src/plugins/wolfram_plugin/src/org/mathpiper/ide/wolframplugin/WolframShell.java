...
public class WolframShell extends Shell implements org.mathpiperide.ResponseListener
{
	private WolframWrapper wolfram;
	private String wolframStartMessage;
	...
	public WolframShell()
	{
		...
		try{
			...
			wolfram = WolframWrapper.getInstance(); 
			wolframStartMessage = wolfram.getStartMessage();
			wolfram.addResponseListener(this);
		}catch(Throwable t)
		{
			t.printStackTrace();
		}
	...
	{
		output.print(null,wolframStartMessage);
	...
	public void response(String response)
	{
		...
		lastRequestConsole.setShell("Wolfram");
	...
	{
		//Note:tk: must set output and console another way for when user executes wolfram fold
	...
	{
		output.writeAttrs(ConsolePane.colorAttributes(console.getPlainColor()), wolfram.getPrompt());
	}//end method.
