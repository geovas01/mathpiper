...
public class EMU6551 extends javax.swing.JPanel implements IOChip, ActionListener, KeyListener {
    ...
    private JButton resetButton, fontDecreaseButton, fontIncreaseButton, interruptButton;
    ...
    public EMU6551() {
        ...
        /* B400 */ ioChips[10] = new EMURandomIOChip();
        /* B600 */ ioChips[11] = new EMURandomIOChip();
        /* B800 */ ioChips[12] = new EMURandomIOChip();
        /* BA00 */ ioChips[13] = new EMURandomIOChip();
        /* BC00 */ ioChips[14] = new EMURandomIOChip();
        /* BE00 */ ioChips[15] = new EMURandomIOChip();
        ...
        try {
            ...
            java.io.InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("resources/ttf-bitstream-vera-1.10/VeraMono.ttf");
            ...
            interruptButton = new JButton("IRQ");
            interruptButton.addActionListener(this);
            buttons.add(interruptButton);
            fontDecreaseButton = new JButton("Font--");
            fontDecreaseButton.addActionListener(this);
            buttons.add(fontDecreaseButton);
            fontIncreaseButton = new JButton("Font++");
            fontIncreaseButton.addActionListener(this);
            buttons.add(fontIncreaseButton);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (src == resetButton) {
            this.resetAll();
        } else if (src == interruptButton) {
            this.irq();
        } else if (src == fontDecreaseButton) {
            this.fontSize -= 2;
            bitstreamVera = bitstreamVera.deriveFont(fontSize);
            typeArea.setFont(bitstreamVera);
            typeArea.setCaretPosition(typeArea.getDocument().getLength());
        ...
        } else if (src == fontIncreaseButton) {
            this.fontSize += 2;
            bitstreamVera = bitstreamVera.deriveFont(fontSize);
            typeArea.setFont(bitstreamVera);
            typeArea.setCaretPosition(typeArea.getDocument().getLength());
