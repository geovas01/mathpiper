...
// {{{ imports
import org.mathpiper.ide.u6502.EMU6551;
...
//			java.net.URL docsURL = jEdit.getPlugin("org.mathpiper.ide.u6502plugin.U6502Plugin").getPluginJAR().getClassLoader().getResource("scripts/Piper_Docs.bsh");
