 ...
 * The parameter hasvalue and a start and end value, all of type Complex, to be used for animation.
 */
public class ComplexVariableParamAnimateable extends ComplexVariableParam implements Animateable {
	...
	/**
	 * Creates a ComplexVariableParamAnimateable that initially has no name and has value and default value equal to 0,
	...
	/**
	 * Create a ComplexVariableParamAnimateable with a specified name and initial value and with
	 ...
	 * This name is also used for the associated ComplexVariable.
	 * @param value The initial value of the parameter.  This also becomes its default value.
	 * A null value is treated as zero.
	 */
	public ComplexVariableParamAnimateable(String name, Complex value) {
	 ...
	 * @param name The name of the Parameter, which can be null but ordinarily should not be.
	 * The name is also used for the associated variable.
	 * @param value The initial value of the parameter.  This also becomes its default value.
	 * A null value is treated as zero.
	 ...
	 * A null value is treated as zero.
	 */
	public ComplexVariableParamAnimateable(String name, Complex value, Complex start, Complex end) {
		super(name,value);
	 ...
	 */
	public ComplexVariableParamAnimateable(String name, String valueAsString) {
	 ...
	 * occur, if this is not a legal value.
	 */
	public ComplexVariableParamAnimateable(String name, String valueAsString, String startString, String endString) {
