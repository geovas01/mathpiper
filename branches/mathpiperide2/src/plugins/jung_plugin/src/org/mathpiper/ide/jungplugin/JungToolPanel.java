...
public class JungToolPanel extends JPanel {
	private Jung pad;
	...
	public JungToolPanel(Jung qnpad) {
		...
		//label.setVisible(jEdit.getProperty(JungPlugin.OPTION_PREFIX + "show-filepath").equals("true"));
		...
		add(makeCustomButton("piper.save-file", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				JungToolPanel.this.pad.saveFile();
			}
		}));
		add(makeCustomButton("piper.copy-to-buffer",
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						JungToolPanel.this.pad.copyToBuffer();
					}
				}));
		*/
