...
public class JLogOptionPane extends AbstractOptionPane implements
	ActionListener {
	...
	public JLogOptionPane() {
		super(JLogPlugin.NAME);
	}

	public void _init() {

		pathName = new JTextField(jEdit.getProperty(JLogPlugin.OPTION_PREFIX + "path"));
		JButton pickPath = new JButton(jEdit.getProperty(JLogPlugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(JLogPlugin.OPTION_PREFIX + "file"), pathPanel);


	}

	public void _save() {
		jEdit.setProperty(JLogPlugin.OPTION_PREFIX + "path", pathName.getText());
