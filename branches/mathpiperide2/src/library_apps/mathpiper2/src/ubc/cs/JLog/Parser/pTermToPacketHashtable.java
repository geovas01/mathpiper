...
/**
 * Keeps track of <code>jTerms</code> and their associated <code>pPacket</code>
 * s. The packets contain parsing relevant information, which my be needed
 * generate error messages if the term proves to be invalid.
 * 
...
public class pTermToPacketHashtable extends Hashtable {
    ...
    /**
     * Looks up packet in the hash given a term key, and returns the packets
     * token. This just encapsulates a common use of this hashtable.
     * 
     * @param t
     *            The term key.
     * @param pp
