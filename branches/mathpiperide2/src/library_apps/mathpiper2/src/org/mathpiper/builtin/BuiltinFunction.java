...
public abstract class BuiltinFunction {
    ...
    public static void addCoreFunctions(Environment aEnvironment) {
        ...
        functionNameInit = "DefMacroRulebase"; aEnvironment.getBuiltinFunctions().setAssociation(new BuiltinFunctionEvaluator(new DefMacroRulebase(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro),functionNameInit);
        functionNameInit = "DefMacroRulebaseListed"; aEnvironment.getBuiltinFunctions().setAssociation(new BuiltinFunctionEvaluator(new DefMacroRulebaseListed(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro),functionNameInit);
        ...
        functionNameInit = "RulebaseListed"; aEnvironment.getBuiltinFunctions().setAssociation(new BuiltinFunctionEvaluator(new RulebaseListed(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro),functionNameInit);
        ...
        functionNameInit = "Set"; aEnvironment.getBuiltinFunctions().setAssociation(new BuiltinFunctionEvaluator(new Set(functionNameInit), 1, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Macro),functionNameInit);
