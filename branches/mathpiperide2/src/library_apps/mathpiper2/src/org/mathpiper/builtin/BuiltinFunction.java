...
public abstract class BuiltinFunction {
    ...
    public static void addCoreFunctions(Environment aEnvironment) {
        ...
        functionNameInit = "LoadLibraryFunction"; aEnvironment.getBuiltinFunctions().setAssociation(new BuiltinFunctionEvaluator(new LoadLibraryFunction(functionNameInit), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function),functionNameInit);
