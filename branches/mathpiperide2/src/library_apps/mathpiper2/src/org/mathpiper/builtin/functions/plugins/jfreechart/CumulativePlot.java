...
public class CumulativePlot extends BuiltinFunction {
    ...
    public void evaluate(Environment aEnvironment, int aStackTop) throws Exception {
        ...
        if(! Utility.isSublist(argumentsPointer.getCons())) LispError.throwError(aEnvironment, aStackTop, LispError.INVALID_ARGUMENT, "", "CumulativePlot");
        ...
        if(! Utility.isList(argumentsPointer.getCons())) LispError.throwError(aEnvironment, aStackTop, LispError.NOT_A_LIST, "", "CumulativePlot");
