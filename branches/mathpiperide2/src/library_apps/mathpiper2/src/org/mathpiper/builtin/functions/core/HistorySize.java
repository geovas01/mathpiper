...
public class HistorySize extends BuiltinFunction
{
    ...
    public void evaluate(Environment aEnvironment, int aStackTop) throws Exception
    {
        ...
        throw new EvaluationException("Function not yet supported",aEnvironment.iCurrentInput.iStatus.getFileName(), -1, aEnvironment.iCurrentInput.iStatus.getLineNumber(), aEnvironment.iCurrentInput.iStatus.getLineIndex());
    }
}
