...
/// evaluate the function with some arguments.
            ...
            for (int ruleIndex = 0; ruleIndex < numberOfRules; ruleIndex++) {
                ...
                if (matches) {
                    ...
                    try {
                        ...
                        aResult = aEnvironment.iLispExpressionEvaluator.evaluate(aEnvironment, aStackTop, thisRule.getBodyPointer().getCons()); //*** User function is called here.
    ...
    protected Cons[] evaluateArguments(Environment aEnvironment, int aStackTop, Cons aArgumentsPointer) throws Exception {
        ...
        ConsPointer argumentsTraverser = new ConsPointer(aArgumentsPointer);
