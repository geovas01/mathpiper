...
public class Scripts {
    ...
    public Scripts() {
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "Rulebase(\"AssignArray\", {listOrAssociationList, indexOrKey, newValue});UnFence(\"AssignArray\", 3);Rule(\"AssignArray\", 3, 1, String?(indexOrKey))[ Local(keyValuePair); keyValuePair := Assoc(indexOrKey, listOrAssociationList); If(keyValuePair =? Empty, DestructiveInsert(listOrAssociationList, 1 , {indexOrKey, newValue}), DestructiveReplace(keyValuePair, 2 , newValue) ); True;];Rule(\"AssignArray\",3,1, And?( Equal?(Generic?(listOrAssociationList), True), Equal?(GenericTypeName(listOrAssociationList), \"Array\")))[ ArraySet(listOrAssociationList, indexOrKey, newValue);];Rule(\"AssignArray\",3 , 2, True)[ DestructiveReplace(listOrAssociationList, indexOrKey, newValue); True;];";
