...
public class Scripts {
    ...
    public Scripts() {
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "20 # GetPrimePower(n_PositiveInteger?) <--[ Local(s, factors, new'factors);  factors := TrialFactorize(n, 257);  If( Length(factors) >? 1,   If( factors[1] =? 1 And? Length(factors) =? 2,  factors[2], {n, 1} ),  [ factors := CheckIntPower(n, 257);  If( factors[2] >? 1,   If( Prime?(factors[1]), factors,  [  new'factors := GetPrimePower(factors[1]);  If( new'factors[2] >? 1, {new'factors[1], new'factors[2]*factors[2]},  {n, 1}  ); ] ),  {n, 1} ); ] );];";
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "5 # IsComposite(1) <-- False;10 # IsComposite(n_PositiveInteger?) <-- (Not? Prime?(n));";
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "10 # IsQuadraticResidue(_a,_p) <--[ Check( Integer?(a) And? Integer?(p) And? p>?2 And? IsCoprime(a,p) And? Prime?(p), \"Argument\", \"IsQuadraticResidue: Invalid arguments\"); If(a^((p-1)/2) % p =? 1, True, False);];";
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "IsTwinPrime(n_PositiveInteger?) <-- (Prime?(n) And? Prime?(n+2));";
        scriptMap.put("IsTwinPrime",scriptString);

        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "10 # LegendreSymbol(_a,_p) <--[ Check( Integer?(a) And? Integer?(p) And? p>?2 And? IsCoprime(a,p) And? Prime?(p), \"Argument\", \"LegendreSymbol: Invalid arguments\"); If(IsQuadraticResidue(a,p), 1, -1 );];";
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "2 # Prime?(_n)_(Not? Integer?(n) Or? n<=?1) <-- False;3 # Prime?(n_Integer?)_(n<=?FastIsPrime(0)) <-- IsSmallPrime(n);5 # Prime?(n_PositiveInteger?)_(n >? 4 And? Modulo(n^2-1,24)!=?0) <-- False;10 # Prime?(n_PositiveInteger?) <-- RabinMiller(n);";
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "Function(\"IsGaussianPrime\",{x})[ if( IsGaussianInteger(x) )[ if( Zero?(Re(x)) )[ ( Abs(Im(x)) % 4 =? 3 And? Prime?(Abs(Im(x))) ); ] else if ( Zero?(Im(x)) ) [ ( Abs(Re(x)) % 4 =? 3 And? Prime?(Abs(Re(x))) ); ] else [ Prime?(Re(x)^2 + Im(x)^2); ]; ] else [ False; ];];";
