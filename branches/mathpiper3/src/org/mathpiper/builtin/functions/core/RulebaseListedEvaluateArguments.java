...
public class RulebaseListedEvaluateArguments extends BuiltinFunction
{
    ...
    public void evaluate(Environment aEnvironment, int aStackBase) throws Exception {
        org.mathpiper.lisp.Utility.defineRulebase(aEnvironment, aStackBase, true);
    }
...
*SEE Bind, Unbind, Local, RulebaseHoldArguments, RuleHoldArguments, `, MacroBind, MacroUnbind, MacroLocal, MacroRulebase, RuleEvaluateArguments
%/mathpiper_docs
*/
