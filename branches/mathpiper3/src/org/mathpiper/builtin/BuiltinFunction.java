...
public abstract class BuiltinFunction {
    ...
    public static void addCoreFunctions(Environment aEnvironment) {
        ...
        functionNameInit = "GarbageCollect"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new GarbageCollect(functionNameInit), 0, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        ...
        functionNameInit = "TraceOff"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new TraceOff(functionNameInit), 0, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "TraceOn"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new TraceOn(functionNameInit), 0, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "TraceRule"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new TraceRule(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        functionNameInit = "TraceSome"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new TraceSome(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        aEnvironment.iBodiedOperators.setOperator(MathPiperPrinter.KMaxPrecedence, functionNameInit);
        functionNameInit = "TraceStack"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new TraceStack(functionNameInit), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        functionNameInit = "Type"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Type(functionNameInit), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "UnFence"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new UnFence(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "Unbind"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Unbind(functionNameInit), 1, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Macro));
        functionNameInit = "MacroUnbind"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Unbind(functionNameInit), 1, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Function));
        functionNameInit = "UnicodeToString"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new UnicodeToString(functionNameInit), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "Version"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Version(functionNameInit), 0, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "While"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new While(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        functionNameInit = "Write"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Write(functionNameInit), 1, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Function));
        functionNameInit = "WriteString"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new WriteString(functionNameInit), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "XmlExplodeTag"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new XmlExplodeTag(aEnvironment, functionNameInit), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
        functionNameInit = "XmlTokenizer"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new XmlTokenizer(functionNameInit), 0, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));


        /*name = "Return"; aEnvironment.iBuiltinFunctions.setAssociation(new BuiltinFunctionEvaluator(new org.mathpiper.builtin.functions.core.Return(), 1, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function), name);*/
