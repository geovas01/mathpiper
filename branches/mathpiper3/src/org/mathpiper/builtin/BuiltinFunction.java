...
public abstract class BuiltinFunction {
    ...
    public static void addCoreFunctions(Environment aEnvironment) {
        ...
        functionNameInit = "NEOn"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new NEOn(functionNameInit), 0, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Function));
