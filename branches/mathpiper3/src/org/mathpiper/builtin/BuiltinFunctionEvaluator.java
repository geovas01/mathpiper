    ...
    public void evaluate(Environment aEnvironment, int aStackBase, Cons aArguments) throws Exception {
        ...
        if (isTraced(functionName)) {
            ...
            if (iNumberOfArguments == 0) {
                ...
                if(iNumberOfArguments <= 0) LispError.lispAssert(aEnvironment, aStackBase);
        ...
        if ((iFlags & Variable) == 0) { //This function has a fixed number of arguments.
            ...
            LispError.checkNumberOfArguments(aStackBase, iNumberOfArguments + 1, aArguments, aEnvironment);
        }
        ...
        if ((iFlags & Macro) != 0) {//This is a macro, not a function. Don't evaluate arguments.
            ...
            for (i = 0; i < numberOfArguments; i++) {
                ...
                if(argumentsConsTraverser == null) LispError.throwError(aEnvironment, aStackBase, LispError.WRONG_NUMBER_OF_ARGUMENTS, "The number of arguments passed in was " + numberOfArguments);
            ...
            if ((iFlags & Variable) != 0) {//This macro has a variable number of arguments.
                ...
                aEnvironment.iArgumentStack.pushArgumentOnStack(SublistCons.getInstance(aEnvironment, head), aStackBase, aEnvironment);
            }//end if.
        ...
        iCalledBuiltinFunction.evaluate(aEnvironment, oldStackTop); //********************** built in function is called here.
