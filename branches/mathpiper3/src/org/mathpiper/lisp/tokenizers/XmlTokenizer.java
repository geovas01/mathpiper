...
public class XmlTokenizer
    ...
    /// or an empty list.
    @Override
    public String nextToken(Environment aEnvironment, int aStackBase, MathPiperInputStream aInput)
            throws Exception {
        ...
        if (c == '<') {
            ...
            while (c != '>') {
                c = aInput.next();
                if(aInput.endOfStream()) LispError.throwError(aEnvironment, aStackBase, LispError.COMMENT_TO_END_OF_FILE, "Last character read was <" + c + ">.");
            }
        } else {
