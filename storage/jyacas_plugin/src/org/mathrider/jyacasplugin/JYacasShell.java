...
public class JYacasShell extends Shell
{
	private JYacasInterpreter interpreter;
	
	
	public JYacasShell() throws net.sf.yacas.Yacasexception
	{
		super("JYacas");
	...
	public void printInfoMessage(Output output)
	{
		...
		printUsage(jEdit.getProperty(JYacasPlugin.NAME + ".shell.msg.info"), null, output);
		output.print(null, jEdit.getProperty(JYacasPlugin.NAME + ".shell.msg.usage"));
