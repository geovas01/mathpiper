...
public abstract class BuiltinFunction {
    ...
    public static void addCoreFunctions(Environment aEnvironment) {
        ...
        functionNameInit = "Assign"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Assign(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        ...
        functionNameInit = "Equivales?"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Equivales_(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        ...
        functionNameInit = "State"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new State(functionNameInit), 0, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Function));
        ...
        functionNameInit = "Implies?"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Implies_(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        ...
        functionNameInit = "MacroAssign"; aEnvironment.iBuiltinFunctions.setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new MacroAssign(functionNameInit), 2, BuiltinFunctionEvaluator.Fixed | BuiltinFunctionEvaluator.Macro));
        ...
        functionNameInit = "Unassign"; aEnvironment.getBuiltinFunctions().setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Unassign(functionNameInit), 1, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Macro));
        functionNameInit = "MacroUnassign"; aEnvironment.getBuiltinFunctions().setAssociation(functionNameInit, new BuiltinFunctionEvaluator(new Unassign(functionNameInit), 1, BuiltinFunctionEvaluator.Variable | BuiltinFunctionEvaluator.Function));
