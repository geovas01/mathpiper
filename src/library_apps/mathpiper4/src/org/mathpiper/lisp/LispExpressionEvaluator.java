...
public class LispExpressionEvaluator extends Evaluator {
	...
	if (Environment.haltEvaluation == true) {
	    ...
	    LispError.throwError(aEnvironment,-2,Environment.haltEvaluationMessage,-1,-1,-1);
	}
    ...
    SingleArityRulebase getUserFunction(Environment aEnvironment, int aStackTop, Cons subList)
	    throws Throwable {
	Cons head = subList;
