...
public class CYacas
{
  ...
  public String Evaluate(String input) throws Yacasexception
  {
    if (input.length() == 0)
      return "";
    String rs = "";
    try
    {
      ...
      if (env.iPrettyReader != null)
      {
        ...
        {
          throw new Yacasexception(e.getMessage());//tk. Throw Yacasexception instead of just exception.
        }
        finally
        {
    ...
    {
//      e.printStackTrace();
      //System.out.println(e.toString());  tk throw Yacasexception instead of simply printing the exception message.
      iError = e.getMessage();
      
      throw new Yacasexception(iError);
    }
    return rs;
  }
