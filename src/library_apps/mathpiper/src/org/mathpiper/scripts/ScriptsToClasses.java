...
public class ScriptsToClasses {
            ...
            if (scriptsDir.exists()) {
                ...
                for (int x = 0; x < packagesDirectory.length; x++) {
                    ...
                    if (packageDirectoryFile.exists()) {
                        ...
                        writeStringToFile(f.toString(), "/home/tkosan/NetBeansProjects/mathpiper/src/org/mathpiper/scripts/" + classNameUpper + ".java");
                        int d = 0;
                    }//end if.
                ...
                writeStringToFile(s.toString(), "/home/tkosan/NetBeansProjects/mathpiper/src/org/mathpiper/scripts/Scripts.java");
    ...
    public static void main(String[] args) {
        ...
        scripts.classify(scriptsDirectory);
