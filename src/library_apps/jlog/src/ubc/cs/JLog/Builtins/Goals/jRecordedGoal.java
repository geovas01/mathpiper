...
public class jRecordedGoal extends jGoal {
	
	protected jRecorded recorded;

    public jTerm term1, term2, term3;

    public jRecordedGoal(jRecorded jred, jTerm t1, jTerm t2,
	    jTerm t3) {
	recorded = jred;
	term1 = t1;
	term2 = t2;
