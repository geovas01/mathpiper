...
class BigNumber
{
  ...
  private BigNumber(int pPrecision, int value) {
	  iPrecision = pPrecision;
	  iTensExp = 0;
	  integer = BigInteger.valueOf(value);
  }
  
  private BigNumber(int pPrecision, long value) {
	  iPrecision = pPrecision;
	  iTensExp = 0;
	  integer = BigInteger.valueOf(value);
  }
...
*/
  ...
  /// Multiply two numbers at given precision and put result in *this
   private void Multiply( BigNumber aX,  BigNumber aY, int aPrecision)
  {
  ...
  public BigNumber multiply(BigNumber b, int aPrecision) {
		  ...
		  x.Multiply(this, b, aPrecision);
		  return x;
	  }
   
  
  /// Add two numbers at given precision and return result in *this
  private void Add( BigNumber aX,  BigNumber aY, int aPrecision)
  {
    boolean floatResult = (aX.decimal != null || aY.decimal != null);
    if (floatResult)
    {
  ...
  private void Negate( BigNumber aX)
  {
    if (aX.integer != null)
    {
      decimal = null;
  ...
  public BigNumber divide(BigNumber b, int aPrecision) {
	  BigNumber x = new BigNumber(aPrecision);
	  x.Divide(this, b, aPrecision);
	  return x;
  }

  /// integer operation: *this = y mod z
  private void Mod( BigNumber aY,  BigNumber aZ) throws Exception
  {
...
//TODO fixme    LispError.Check(!IsZero(aZ),LispError.KLispErrInvalidArg);
  ...
  private void Floor( BigNumber aX)
  {
    if (aX.decimal != null)
    {
  ...
  public BigNumber floor(int aPrecesion) {
	  BigNumber x = new BigNumber(aPrecesion);
	  x.Floor(this);
	  return x;
  }
  ...
  private void ShiftLeft(  BigNumber aX, int aNrToShift) throws Exception
  {
  ...
  private void ShiftRight(  BigNumber aX, int aNrToShift) throws Exception
  {
    LispError.LISPASSERT(aX.integer != null);
    decimal = null;
  ...
  private void Gcd( BigNumber aX,  BigNumber aY) throws Exception
  {
    LispError.LISPASSERT(aX.integer != null);
  ...
  private void BitAnd( BigNumber aX,  BigNumber aY) throws Exception
  {
    LispError.LISPASSERT(aX.integer != null);
    LispError.LISPASSERT(aY.integer != null);
  ...
  private void BitOr( BigNumber aX,  BigNumber aY) throws Exception
  {
    LispError.LISPASSERT(aX.integer != null);
    LispError.LISPASSERT(aY.integer != null);
  ...
  private void BitXor( BigNumber aX,  BigNumber aY) throws Exception
  {
    LispError.LISPASSERT(aX.integer != null);
    LispError.LISPASSERT(aY.integer != null);
  ...
  private void BitNot( BigNumber aX) throws Exception
  {
    LispError.LISPASSERT(aX.integer != null);
