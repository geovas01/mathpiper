...
class BasicEvaluator extends LispEvaluatorBase
{
  ...
  public void Eval(LispEnvironment aEnvironment, LispPtr aResult, LispPtr aExpression) throws Exception
  {
    ...
    String str = aExpression.getNext().String();
    ...
    if (str != null)
    {
      if (str.charAt(0) == '\"')
      {
        aResult.setNext(aExpression.getNext().Copy(false));
        aEnvironment.iEvalDepth--;
        return;
      }
      ...
      if (val.getNext() != null)
      {
        aResult.setNext(val.getNext().Copy(false));
        aEnvironment.iEvalDepth--;
        return;
      }
      aResult.setNext(aExpression.getNext().Copy(false));
...

    {
      ...
      if (subList != null)
      {
        ...
        if (head != null)
        {
          ...
          {
            {
              PiperEvaluator evaluator = (PiperEvaluator)aEnvironment.CoreCommands().get(head.String());
          ...
          else
          {
            ...
            oper.setNext(subList.getNext());
            args2.setNext(subList.getNext().getNext());
