...
public class Scripts {
    ...
    public Scripts() {
        ...
        scriptString[0] = null;
        scriptString[1] = "Rulebase(MathPiperInitLoad,{});Rule(MathPiperInitLoad, 0, 1, True)[      StandardOperatorsLoad(); Constant(True);                 ];";
        ...
        scriptString = new String[2];
        scriptString[0] = null;
        scriptString[1] = "LocalSymbols(NFunctionNumberize)[NFunction(newname_String?, oldname_String?, arglist_List?) <-- [ MacroRulebase(newname, arglist); MacroRule(newname, Length(arglist), 0,  ListToFunction({NumericList?, arglist}) )  NFunctionNumberize(ListToFunction({ToAtom(\"@\"), oldname, arglist})); ];10 # NFunctionNumberize(x_Number?) <-- x;20 # NFunctionNumberize(x_Atom?) <-- Undefined;]; ";
