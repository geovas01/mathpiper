...
public class jCutGoal extends jGoal
{
 ...
 {
  // we should cut out the proved goals that would never retry because of cut.
  ...
  if (rule_goal != null)
  {
   ...
   {jGoal 	g2;
    ...
    if (rule_goal instanceof jPredicateGoal && g2 instanceof jCutGoal)
    {jPredicateGoal		pg = (jPredicateGoal) rule_goal;
	 jCutGoal			cg2 = (jCutGoal) g2;
   
     if (cg2.rule_goal != null && cg2.rule_goal instanceof jPredicateGoal)
	 {jPredicateGoal		pg2 = (jPredicateGoal) cg2.rule_goal;
	
	  if (pg.getRules() == pg2.getRules() && pg.getRuleNumber() == pg2.getRuleNumber()) 
       proved.cut(g2);
     }
    }
   }
 ...
 public boolean 	retry(iGoalStack goals,iGoalStack proved)
 {
  ...
  if (rule_goal != null)
  {
   ...
   goals.push(proved.pop()); // a retry that follows may need a node to remove or retry
  }
  return false;
 }; 
