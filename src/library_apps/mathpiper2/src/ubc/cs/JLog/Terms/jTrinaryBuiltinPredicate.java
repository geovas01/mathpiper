...
abstract public class jTrinaryBuiltinPredicate extends jBuiltinPredicate {
	...
	goals.push(new jTrinaryBuiltinPredicateGoal(this,
    ...
    // since trinary predicates have variables, they should be able to duplicate
    // themselves
    // this version of duplicate only requires subclasses to create themselves.
    abstract protected jTrinaryBuiltinPredicate duplicate(jTerm t1, jTerm t2,
	    jTerm t3);
