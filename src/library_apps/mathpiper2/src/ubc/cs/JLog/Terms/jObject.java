...
/**
 * This is the term used to reference Java objects. It is not created by the
 * parser, instead special builtin predicates which require such references
 * provide a constructor predicate which create a jObject instance.
 * 
...
public class jObject extends jTerm {
	...
	// altough we cannot be certain that term is a jObject, if it is not
	// then type was wrong
	...
	return this; // since objects are constants, don't duplicate for memory
