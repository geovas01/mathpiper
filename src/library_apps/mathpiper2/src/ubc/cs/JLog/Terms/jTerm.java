...
abstract public class jTerm extends jType implements iTerm {
    ...
    /**
     * The private member function for term comparision. Compares this instance
     * to the provided <code>jTerm</code>. sub-classes must override.
     * 
     * @param term
     *            the <code>jTerm</code> to compare with this instance of
     *            <code>jTerm</code>. if <code>term</code> is an unknown type
     *            then, if <code>first_call</code> is <code>true</code>, call
     *            term.compare(this,false) and return the negative result,
     *            otherwise return <code>EQUAL</code>.
     * @param first_call
     ...
     *         <code>term</code>.
     */
    abstract protected int compare(jTerm term, boolean first_call,
	    boolean var_equal);
     ...
     * all variables encountered should be unbound. After call, this term should
     ...
     * this term) to the <code>jVariableVector</code>
     * 
     * @param v
