...
public class jPrologFileServices implements iPrologFileServices {
    public static String getTextFromInputStream_S(InputStream in_strm)
	    throws IOException {
	BufferedReader b_read = new BufferedReader(new InputStreamReader(
		in_strm));
    ...
    public static URL getResourceURLFromFilename_S(String name)
	    throws MalformedURLException, IOException {// URL rsrc_url =
						       ...
						       // // works for both, but
						       // uses v1.2 feature
	URL rsrc_url = jPrologServices.class.getClassLoader().getResource(name); // works
										 // for
										 // both
										 // --
										 // in
    ...
    public static InputStream getResourceInputStreamFromFilename_S(String name)
	    throws MalformedURLException, IOException {// InputStream in =
						       // ClassLoader.getSystemResourceAsStream(name);
						       // InputStream in =
						       // Thread.currentThread().getContextClassLoader().getResourceAsStream(name);
	InputStream in = jPrologServices.class.getClassLoader()
