...
/**
* <code>iGoalStack</code> is the goal stack interface.
...
public interface iGoalStack
{
 ...
 /**
  * Places the provided goal <code>item</code> as the top element of the stack.
  *
  * @param item 	the goal to add to the stack top.
  * @return 		the top <code>jGoal</code> of the stack, which is the 
  *			provided <code>item</code>.
  */
 public jGoal 		push(jGoal item);
 
 /**
  * Removes all goals above the specified <code>item</code>.  <code>item</code> 
  * becomes the top goal.
  *
  * @param item 	the goal to truncate the stack at. <code>item</code> becomes
