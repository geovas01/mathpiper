...
public class MathPiperPrinter extends LispPrinter {
    ...
    @Override
    public void print(int aStackBase, Cons aExpression,  MathPiperOutputStream aOutput, Environment aEnvironment) throws Exception {
        iCurrentEnvironment = aEnvironment;


        Print(aEnvironment, aStackBase, aExpression, aOutput, KMaxPrecedence);
    ...
    void Print(Environment aEnvironment, int aStackBase, Cons aExpression, MathPiperOutputStream aOutput, int iPrecedence) throws Exception {
        ...
        if(subList == null) LispError.throwError(aEnvironment, aStackBase, LispError.UNPRINTABLE_TOKEN, "");

        if (subList == null) {
            WriteToken(aOutput, "( )");
        } else {
            int length = Utility.listLength(aEnvironment, aStackBase, subList);
            ...
            if (operator != null) {
                ...
                if (left != null) {
                    ...
                    Print(aEnvironment, aStackBase, left, aOutput, operator.iLeftPrecedence);
                ...
                if (right != null) {
                    ...
                    Print(aEnvironment, aStackBase, right, aOutput, operator.iRightPrecedence);
               ...
               /*
                ...
                if (functionOrOperatorName.equals(iCurrentEnvironment.iListAtom.car())) {
                    ...
                    while (consTraverser != null) {
                        Print(aEnvironment, aStackBase, consTraverser, aOutput, KMaxPrecedence);
                ...
                } else if (functionOrOperatorName.equals(iCurrentEnvironment.iProgAtom)) // Program block brackets.
                {
                    ...
                    Print(aEnvironment, aStackBase, consTraverser, aOutput, 0);
                    consTraverser = consTraverser.cdr();
                    WriteToken(aOutput, "[");
                    Print(aEnvironment, aStackBase,  consTraverser, aOutput, KMaxPrecedence);
                    WriteToken(aOutput, "]");
                    ...
                    if (functionOrOperatorName != null) {
                        ...
                        Print(aEnvironment, aStackBase, subList, aOutput, 0);
                    }
                    ...
                    while (nr-- != 0) {
                        Print(aEnvironment, aStackBase, consTraverser, aOutput, KMaxPrecedence); //Print argument.
                    ...
                    if (consTraverser != null) {
                        Print(aEnvironment, aStackBase, consTraverser, aOutput, bodied.iPrecedence);
                    }
