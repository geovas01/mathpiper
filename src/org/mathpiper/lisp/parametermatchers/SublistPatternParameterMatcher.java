...
public class SublistPatternParameterMatcher extends PatternParameterMatcher {
    ...
    public boolean argumentMatches(Environment aEnvironment, int aStackBase, Cons aExpression, Cons[] arguments) throws Exception {
        ...
        for (int i = 0; i < iNumberOfMatchers; i++) {
            ...
            if (!iMatchers[i].argumentMatches(aEnvironment, aStackBase, consTraverser, arguments)) {
                return false;
            }
