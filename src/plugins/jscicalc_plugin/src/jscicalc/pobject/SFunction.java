 ...
 * This class specifies what is needed for a SFunction and allows Parser
 * to handle a SFunction without knowing the exact type.
 * @see Parser
 *
 * @author J.&nbsp;D.&nbsp;Lamb
 * @version $Revision: 1.1 $
 */
public abstract class SFunction extends PObject {
    /**
     ...
     * @return The result of the operation
     */
    public abstract OObject function( OObject x ); 
}
