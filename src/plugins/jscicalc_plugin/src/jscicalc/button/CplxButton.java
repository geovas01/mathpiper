...
public class CplxButton extends CalculatorButton {
    ...
    /**
     * Cosntructor. Sets PObject to Cplx.
     * @param applet The <em>controller</em> object
     * behave
     */
    public CplxButton( CalculatorApplet applet ){
	//super( applet );
	this.applet = applet;
	this.pobject = new Cplx();
	setText();
	...
	synchronized( applet ){
	    ...
	    getApplet().getNotation().toggle( Notation.COMPLEX );
