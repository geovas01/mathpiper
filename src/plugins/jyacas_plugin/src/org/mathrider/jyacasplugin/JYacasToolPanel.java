 ...
 *
 * $Id: JYacasToolPanel.java 5275 2005-09-10 19:40:17Z ezust $
 */
...
public class JYacasToolPanel extends JPanel {
	private JYacas pad;

	private JLabel label;

	public JYacasToolPanel(JYacas qnpad) {
		...
		add(makeCustomButton("jyacas.choose-file", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				JYacasToolPanel.this.pad.chooseFile();
			}
		}));
		add(makeCustomButton("jyacas.save-file", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				JYacasToolPanel.this.pad.saveFile();
			}
		}));
		add(makeCustomButton("jyacas.copy-to-buffer",
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						JYacasToolPanel.this.pad.copyToBuffer();
					}
				}));
	}
