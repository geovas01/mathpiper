 ...
 *
 * $Id: HotEqnOptionPane.java 5275 2005-09-10 19:40:17Z ezust $
 */
...
public class HotEqnOptionPane extends AbstractOptionPane implements
		ActionListener {
	...
	public HotEqnOptionPane() {
		super(HotEqnPlugin.NAME);
	}

	public void _init() {
		showPath = new JCheckBox(jEdit
				.getProperty(HotEqnPlugin.OPTION_PREFIX
		...
		JButton pickPath = new JButton(jEdit
				.getProperty(HotEqnPlugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(HotEqnPlugin.OPTION_PREFIX
				+ "file"), pathPanel);
	...
	public void _save() {
		jEdit.setProperty(HotEqnPlugin.OPTION_PREFIX + "filepath",
				pathName.getText());
		Font _font = font.getFont();
		jEdit.setProperty(HotEqnPlugin.OPTION_PREFIX + "font", _font
				.getFamily());
		jEdit.setProperty(HotEqnPlugin.OPTION_PREFIX + "fontsize", String
				.valueOf(_font.getSize()));
		jEdit.setProperty(HotEqnPlugin.OPTION_PREFIX + "fontstyle",
				String.valueOf(_font.getStyle()));
		jEdit.setProperty(HotEqnPlugin.OPTION_PREFIX + "show-filepath",
	...
	static public Font makeFont() {
		int style, size;
		String family = jEdit.getProperty(HotEqnPlugin.OPTION_PREFIX
				+ "font");
		try {
			size = Integer
					.parseInt(jEdit
