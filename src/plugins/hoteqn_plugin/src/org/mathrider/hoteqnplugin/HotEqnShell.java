...
public class HotEqnShell extends Shell
{
	private PiperInterpreter interpreter;
	
	
	public HotEqnShell() throws org.mathrider.piper.Piperexception
	{
		super("HotEqn");
	...
	public void printInfoMessage(Output output)
	{
		...
		printUsage(jEdit.getProperty(HotEqnPlugin.NAME + ".shell.msg.info"), null, output);
		output.print(null, jEdit.getProperty(HotEqnPlugin.NAME + ".shell.msg.usage"));
