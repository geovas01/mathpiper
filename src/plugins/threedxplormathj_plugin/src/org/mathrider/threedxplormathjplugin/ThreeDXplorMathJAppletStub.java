...
public class ThreeDXplorMathJAppletStub extends Object implements AppletStub
{
     JPanel appletJPanel;
     Applet applet;
     String appletName;
     ...
     public ThreeDXplorMathJAppletStub()
     {
     }
...
// separators must be '/' and not '\' or the URL class gets confused.
     ...
     public ThreeDXplorMathJAppletStub(JPanel appletJPanel, Applet applet, String name,
          String startDir)
     {
...
// try just the param name.
     ...
     public String getParameter(String paramName)
     {
	   ...
	   String prop = jEdit.getProperty(ThreeDXplorMathJPlugin.NAME + ".applet."+paramName);
