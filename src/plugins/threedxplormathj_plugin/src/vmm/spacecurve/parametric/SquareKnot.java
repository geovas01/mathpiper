...
public class SquareKnot extends SpaceCurveParametric {
	...
	protected Vector3D value(double t) {
		return new Vector3D( 
				...
				(11*Math.cos(t) - 43*Math.sin(3*t) +34*Math.cos(5*t) - 39*Math.sin(5*t))/100, 
				( 70*Math.cos(3*t) - 40*Math.sin(3*t) + 18*Math.cos(5*t) -9*Math.sin(5*t))/100 
			);
	}
	...
	protected Vector3D deriv1(double t) {
		return new Vector3D( 
				...
				(-11*Math.sin(t) - 43*Math.cos(3*t)*3 -34*Math.sin(5*t)*5 - 39*Math.cos(5*t)*5)/100, 
				(-70*Math.sin(3*t)*3 - 40*Math.cos(3*t)*3 - 18*Math.sin(5*t)*5 -9*Math.cos(5*t)*5)/100 
			);
	}
	...
	protected Vector3D deriv2(double t) {
		return new Vector3D( 
				...
				(-11*Math.cos(t) + 43*Math.sin(3*t)*9 -34*Math.cos(5*t)*25 +39*Math.sin(5*t)*25)/100, 
				(-70*Math.cos(3*t)*3*3 + 40*Math.sin(3*t)*3*3 - 18*Math.cos(5*t)*25 +9*Math.sin(5*t)*25)/100 
			);
	}
