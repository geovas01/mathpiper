...
public class U6502ToolPanel extends JPanel  implements ActionListener {
	private U6502 pad;
	...
	public U6502ToolPanel(U6502 qnpad) {
		...
		label.setVisible(jEdit.getProperty(
				U6502Plugin.OPTION_PREFIX + "show-filepath").equals(
				"true"));
...
//		//View source button.
//		String toolTip = jEdit.getProperty("u6502.source.label");
//		sourceButton = new javax.swing.JButton(jEdit.getProperty("u6502.source.button-text"));
//		sourceButton.addActionListener(new ActionListener() {
//			public void actionPerformed(ActionEvent evt) {
//				U6502ToolPanel.this.pad.source();
//			}
//		});
...
//		
		...
		//Cell editor.
		/*
		String toolTip = "Edit cell"; //jEdit.getProperty("u6502.source.label");
		JButton cellEditButton = new javax.swing.JButton("Cell editor"); //jEdit.getProperty("u6502.source.button-text"));
		...
		*/
		...
		//add(Box.createGlue());
                //
		//add(makeCustomButton("u6502.home", new ActionListener() {
		//	public void actionPerformed(ActionEvent evt) {
		//		U6502ToolPanel.this.pad.home();
		//	}
		//}));
		...
		add(makeCustomButton("piper.save-file", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				U6502ToolPanel.this.pad.saveFile();
			}
		}));
		add(makeCustomButton("piper.copy-to-buffer",
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						U6502ToolPanel.this.pad.copyToBuffer();
					}
				}));
		*/
	...
	public void actionPerformed(ActionEvent evt) {
		...
		//this.popUpCellEditor.run();
		 //U6502.jSciCalcPanel.moduleContext.getTable());  //U6502ToolPanel.this.pad.source();
	}
