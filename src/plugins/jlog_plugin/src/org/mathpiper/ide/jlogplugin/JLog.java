...
/**
 * 
 * jlog - a dockable JPanel, a demonstration of a jEdit plugin.
 *
 */
public class JLog extends JPanel
    implements EBComponent, JLogActions, DefaultFocusComponent {
	...
	private JLogTextArea textArea;

	private JLogToolPanel toolPanel;
    // }}}
	 ...
	 */
	public JLog(View view, String position) {
		super(new BorderLayout());
		this.view = view;
		this.floating = position.equals(DockableWindowManager.FLOATING);


		//this.toolPanel = new JLogToolPanel(this);
		//add(BorderLayout.NORTH, this.toolPanel);

		if (floating)
			this.setPreferredSize(new Dimension(500, 250));

		textArea = new JLogTextArea();
