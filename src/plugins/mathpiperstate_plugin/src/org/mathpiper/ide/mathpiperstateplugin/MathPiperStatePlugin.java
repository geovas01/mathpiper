 ...
 * @author Ted Kosan
 */
public class MathPiperStatePlugin extends EditPlugin implements EBComponent{
	public static final String NAME = "mathpiperstate";
	public static final String OPTION_PREFIX = "options.mathpiperstate.";
	...
	public void start()
	{
		...
		//jEdit.getActiveView().getDockableWindowManager().addDockableWindow(org.mathpiper.ide.mathpiperplugin.MathPiperStatePlugin.NAME);
	...
	public void handleMessage(EBMessage msg)
	{
		...
		if (msg instanceof org.gjt.sp.jedit.msg.EditorStarted) {
			...
			org.mathpiper.interpreters.EvaluationResponse response = synchronousInterpreter.evaluate("[Import(\"org/mathpiper/builtin/functions/plugins/mathpiperstate/\"); Plot2DOutputs()[\"default\"] := \"mathpiperstate\";];");
