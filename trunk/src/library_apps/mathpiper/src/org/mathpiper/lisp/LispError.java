...
public class LispError
{
    ...
    public static String showFunctionError(ConsPointer aArguments, Environment aEnvironment) throws Exception
    {
        ...
        {
            String string = (String) aArguments.getCons().car();
            if (string != null)
            {
    ...
    {
        checkArgumentTypeWithError(aEnvironment, aStackTop, UtilityFunctions.internalIsString( (String) evaluated.getCons().car()), aArgNr, "argument is not a string.");
    }
