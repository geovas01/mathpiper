 ...
 */
public abstract class SingleArityUserFunction extends Evaluator
{
...
/// evaluate the function with some arguments.
	...
	boolean iFenced;
         ...
         * 
         */
        public SingleArityUserFunction()
	{
		iFenced = true;
		//iTraced = false;
	}
	public abstract void evaluate(Environment aEnvironment,ConsPointer aResult, ConsPointer aArguments) throws Exception;
