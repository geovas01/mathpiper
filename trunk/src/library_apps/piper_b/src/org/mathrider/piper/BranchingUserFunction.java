...
class BranchingUserFunction extends LispArityUserFunction
{
  ...
  class BranchRule extends BranchRuleBase
  {
    public BranchRule(int aPrecedence,LispPtr  aPredicate,LispPtr  aBody)
    {
      ...
      iPredicate.setNext(aPredicate.getNext());
      iBody.setNext(aBody.getNext());
    }
  ...
  class BranchPattern extends BranchRuleBase
  {
    ...
    public BranchPattern(int aPrecedence,LispPtr  aPredicate,LispPtr  aBody) throws Exception
    {
      ...
      GenericClass gen = aPredicate.getNext().Generic();
  ...
  {
    iParamList.setNext(aParameters.getNext());
...
*/
    ...
    for (i=0;i<arity;i++)
    {
        ...
        {
            arguments[i].setNext(iter.GetObject().Copy(false));
        }
        else
        {
...
*/
    ...
    try
    {
      ...
      for (i=0;i<arity;i++)
      {
          ...
          aEnvironment.NewLocal(variable,arguments[i].getNext());
      }
  ...
  */
...

      {
          ...
          {
              full.getNext().setNext(arguments[0].getNext());
              for (i=0;i<arity-1;i++)
              {
                  arguments[i].getNext().setNext(arguments[i+1].getNext());
              }
          }
