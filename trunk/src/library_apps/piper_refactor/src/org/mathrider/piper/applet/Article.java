	...
	void processBody(String aString)
	{
		...
		while (aString.length() > 0)
		{
			...
			else if (name.equals("math"))
			{
				...
				articleBody = articleBody + "<applet code=org.mathrider.piper.FormulaViewApplet archive=\"piper.jar\" width=600 height="+height+"><param name=\"expression\" value=\""+data+"\" /></applet><br />";
			}
