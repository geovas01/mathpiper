...
public class Nth extends BuiltinFunction
{
    ...
    {
        String str;
        str = argumentPointer(aEnvironment, aStackTop, 2).get().string();
        ...
        Utility.internalNth(result(aEnvironment, aStackTop), argumentPointer(aEnvironment, aStackTop, 1), index);
    }
}
