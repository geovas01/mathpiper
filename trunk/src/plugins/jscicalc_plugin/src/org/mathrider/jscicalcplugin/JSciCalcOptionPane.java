...
public class JSciCalcOptionPane extends AbstractOptionPane implements
		ActionListener {
	...
	public JSciCalcOptionPane() {
		super(JSciCalcPlugin.NAME);
	}

	public void _init() {
		showPath = new JCheckBox(jEdit
				.getProperty(JSciCalcPlugin.OPTION_PREFIX
		...
		pathName = new JTextField(jEdit
				.getProperty(JSciCalcPlugin.OPTION_PREFIX + "filepath"));
		JButton pickPath = new JButton(jEdit
				.getProperty(JSciCalcPlugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(JSciCalcPlugin.OPTION_PREFIX
				+ "file"), pathPanel);
	...
	public void _save() {
		jEdit.setProperty(JSciCalcPlugin.OPTION_PREFIX + "filepath",
				pathName.getText());
		Font _font = font.getFont();
		jEdit.setProperty(JSciCalcPlugin.OPTION_PREFIX + "font", _font
				.getFamily());
		jEdit.setProperty(JSciCalcPlugin.OPTION_PREFIX + "fontsize", String
				.valueOf(_font.getSize()));
		jEdit.setProperty(JSciCalcPlugin.OPTION_PREFIX + "fontstyle",
				String.valueOf(_font.getStyle()));
		jEdit.setProperty(JSciCalcPlugin.OPTION_PREFIX + "show-filepath",
	...
	static public Font makeFont() {
		int style, size;
		String family = jEdit.getProperty(JSciCalcPlugin.OPTION_PREFIX
				+ "font");
		try {
			size = Integer
					.parseInt(jEdit
