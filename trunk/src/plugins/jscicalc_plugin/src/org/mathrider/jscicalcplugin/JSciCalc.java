...
/**
 * 
 * JSciCalc - a dockable JPanel..
 *
 */
public class JSciCalc extends JPanel
    implements EBComponent, JSciCalcActions, DefaultFocusComponent {
	...
	//private JSciCalcTextArea textArea;

	private JSciCalcToolPanel toolPanel;
	
	private static JSciCalc jSciCalc;
	
    static jscicalc.CalculatorApplet jSciCalcApplet;
	 ...
	 */
	public JSciCalc(View view, String position) {
...
//		bshInterpreter = new Interpreter();
		...
		jSciCalcApplet = new jscicalc.CalculatorApplet();
		jSciCalcApplet.setup();
		JPanel calcPanel = new JPanel();
		calcPanel.add(jSciCalcApplet);
		add(calcPanel);   

		this.toolPanel = new JSciCalcToolPanel(this);
...
// Initialize and start the applet
	...
	// {{{ getJSciCalc
	public static JSciCalc getJSciCalc()
	{	
		return JSciCalc.jSciCalc;  
	}//end method
	// }}}
	...
	private void propertiesChanged() {
		...
		Font newFont = JSciCalcOptionPane.makeFont();
...
//	}//end method.
	...
	// JSciCalcActions implementation
