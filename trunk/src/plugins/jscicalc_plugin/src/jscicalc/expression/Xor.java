...
/**
 * This class represents an xor function
 *
 * @see Dyadic
 *
 * @author J.&nbsp;D.&nbsp;Lamb
 ...
 */
public class Xor extends Dyadic<jscicalc.pobject.BoolFunction> {
    /**
	...
	super( new jscicalc.pobject.Xor(), expression1, expression2 );
    }
