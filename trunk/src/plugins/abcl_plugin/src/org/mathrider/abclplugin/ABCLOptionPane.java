...
public class ABCLOptionPane extends AbstractOptionPane implements
		ActionListener {
	...
	public ABCLOptionPane() {
		super(ABCLPlugin.NAME);
	}

	public void _init() {
		showPath = new JCheckBox(jEdit
				.getProperty(ABCLPlugin.OPTION_PREFIX
						+ "show-filepath.title"), jEdit.getProperty(
				ABCLPlugin.OPTION_PREFIX + "show-filepath").equals(
				"true"));
		...
		JButton pickPath = new JButton(jEdit
				.getProperty(ABCLPlugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(ABCLPlugin.OPTION_PREFIX
				+ "file"), pathPanel);
	...
	public void _save() {
		jEdit.setProperty(ABCLPlugin.OPTION_PREFIX + "filepath",
				pathName.getText());
		Font _font = font.getFont();
		jEdit.setProperty(ABCLPlugin.OPTION_PREFIX + "font", _font
				.getFamily());
		jEdit.setProperty(ABCLPlugin.OPTION_PREFIX + "fontsize", String
				.valueOf(_font.getSize()));
		jEdit.setProperty(ABCLPlugin.OPTION_PREFIX + "fontstyle",
				String.valueOf(_font.getStyle()));
		jEdit.setProperty(ABCLPlugin.OPTION_PREFIX + "show-filepath",
	...
	static public Font makeFont() {
		int style, size;
		String family = jEdit.getProperty(ABCLPlugin.OPTION_PREFIX
				+ "font");
		try {
			size = Integer
					.parseInt(jEdit
