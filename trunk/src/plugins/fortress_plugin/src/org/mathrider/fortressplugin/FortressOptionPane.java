...
public class FortressOptionPane extends AbstractOptionPane implements
		ActionListener {
	...
	public FortressOptionPane() {
		super(FortressPlugin.NAME);
	}

	public void _init() {
		showPath = new JCheckBox(jEdit
				.getProperty(FortressPlugin.OPTION_PREFIX
						+ "show-filepath.title"), jEdit.getProperty(
				FortressPlugin.OPTION_PREFIX + "show-filepath").equals(
				"true"));
		...
		JButton pickPath = new JButton(jEdit
				.getProperty(FortressPlugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(FortressPlugin.OPTION_PREFIX
				+ "file"), pathPanel);
	...
	public void _save() {
		jEdit.setProperty(FortressPlugin.OPTION_PREFIX + "filepath",
				pathName.getText());
		Font _font = font.getFont();
		jEdit.setProperty(FortressPlugin.OPTION_PREFIX + "font", _font
				.getFamily());
		jEdit.setProperty(FortressPlugin.OPTION_PREFIX + "fontsize", String
				.valueOf(_font.getSize()));
		jEdit.setProperty(FortressPlugin.OPTION_PREFIX + "fontstyle",
				String.valueOf(_font.getStyle()));
		jEdit.setProperty(FortressPlugin.OPTION_PREFIX + "show-filepath",
	...
	static public Font makeFont() {
		int style, size;
		String family = jEdit.getProperty(FortressPlugin.OPTION_PREFIX
				+ "font");
		try {
			size = Integer
					.parseInt(jEdit
