 ...
 *
 */
public class JRST extends JPanel
	implements EBComponent, JRSTActions, DefaultFocusComponent{
	...
	private JRSTToolPanel toolPanel;
	
	private static JRST jrst;
	// }}}
	 ...
	 */
	public JRST(View view, String position) {
		super(new BorderLayout());
		this.view = view;
		this.floating = position.equals(DockableWindowManager.FLOATING);


		//this.toolPanel = new JRSTToolPanel(this);
		...
		//this.add(JRSTPlugin.getChartPanel());
		...
		//org.mathpiper.interpreters.EvaluationResponse response = synchronousInterpreter.evaluate("Import(\"org/mathpiper/builtin/functions/plugins/jrst/\");");
