...
public class JRSTToolPanel extends JPanel {
	private JRST pad;

	private JLabel label;

	public JRSTToolPanel(JRST qnpad) {
		...
		add(makeCustomButton("jrst.choose-file", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				JRSTToolPanel.this.pad.chooseFile();
			}
		}));
		add(makeCustomButton("jrst.save-file", new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				JRSTToolPanel.this.pad.saveFile();
			}
		}));
		add(makeCustomButton("jrst.copy-to-buffer",
				new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						JRSTToolPanel.this.pad.copyToBuffer();
					}
				}));
	}
