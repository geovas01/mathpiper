...
public class U6502OptionPane extends AbstractOptionPane implements
		ActionListener {
	...
	public U6502OptionPane() {
		super(U6502Plugin.NAME);
	}

	public void _init() {
		showPath = new JCheckBox(jEdit
				.getProperty(U6502Plugin.OPTION_PREFIX
		...
		JButton pickPath = new JButton(jEdit
				.getProperty(U6502Plugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(U6502Plugin.OPTION_PREFIX
				+ "file"), pathPanel);
	...
	public void _save() {
		jEdit.setProperty(U6502Plugin.OPTION_PREFIX + "filepath",
				pathName.getText());
		Font _font = font.getFont();
		jEdit.setProperty(U6502Plugin.OPTION_PREFIX + "font", _font
				.getFamily());
		jEdit.setProperty(U6502Plugin.OPTION_PREFIX + "fontsize", String
				.valueOf(_font.getSize()));
		jEdit.setProperty(U6502Plugin.OPTION_PREFIX + "fontstyle",
				String.valueOf(_font.getStyle()));
		jEdit.setProperty(U6502Plugin.OPTION_PREFIX + "show-filepath",
	...
	static public Font makeFont() {
		int style, size;
		String family = jEdit.getProperty(U6502Plugin.OPTION_PREFIX
				+ "font");
		try {
			size = Integer
					.parseInt(jEdit
