 ...
 *
 */
public class 3DXplorMathJ extends JPanel
	implements EBComponent, 3DXplorMathJActions, DefaultFocusComponent{
	...
	private 3DXplorMathJToolPanel toolPanel;
	
	private static 3DXplorMathJ jFreeChart;
	// }}}
	 ...
	 */
	public 3DXplorMathJ(View view, String position) {
		super(new BorderLayout());
		this.view = view;
		this.floating = position.equals(DockableWindowManager.FLOATING);


		//this.toolPanel = new 3DXplorMathJToolPanel(this);
		...
		this.add(3DXplorMathJPlugin.getChartPanel());
		...
		//org.mathpiper.interpreters.EvaluationResponse response = synchronousInterpreter.evaluate("Import(\"org/mathpiper/builtin/functions/plugins/3dxplormathj/\");");
	...
	public static JPanel get3DXplorMathJ()
	{
		return jFreeChart;
	}//end method.
