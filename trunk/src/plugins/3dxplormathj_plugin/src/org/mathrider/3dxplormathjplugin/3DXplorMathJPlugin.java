 ...
 * @author Ted Kosan
 */
public class 3DXplorMathJPlugin extends EditPlugin implements EBComponent{
	public static final String NAME = "3dxplormathj";
	public static final String OPTION_PREFIX = "options.3dxplormathj.";
	...
	public void handleMessage(EBMessage msg)
	{
		...
		if (msg instanceof org.gjt.sp.jedit.msg.EditorStarted) {
			...
			org.mathpiper.interpreters.EvaluationResponse response = synchronousInterpreter.evaluate("[Import(\"org/mathpiper/builtin/functions/plugins/3dxplormathj/\"); Plot2DOutputs()[\"default\"] := \"3dxplormathj\";];");
	...
	private class ChartPanel extends JPanel implements org.mathpiper.interpreters.ResponseListener {
		...
		{
			//3DXplorMathJ handler.
			if(response.getObject() != null)
			{
				Object object = response.getObject();
				if(object instanceof org.jfree.chart.ChartPanel)
				{	
					org.gjt.sp.jedit.jEdit.getActiveView().getDockableWindowManager().showDockableWindow( "3dxplormathj" );
