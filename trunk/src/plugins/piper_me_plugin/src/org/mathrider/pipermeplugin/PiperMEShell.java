...
public class PiperMEShell extends Shell
{
	private PiperMEInterpreter interpreter;
	
	
	public PiperMEShell() throws org.mathrider.piper_me.Piperexception
	{
		super("Piper_ME");
		interpreter = PiperMEInterpreter.getInstance(); //new StreamOutput(System.out) 
	...
	public void printInfoMessage(Output output)
	{
		...
		//printUsage(jEdit.getProperty(PiperMEPlugin.NAME + ".shell.msg.info"), null, output);
		//output.print(null, jEdit.getProperty(PiperMEPlugin.NAME + ".shell.msg.usage"));
		try
		{
			output.print(null, "Piper_ME version " + interpreter.evaluate("Version();") );
		}
		catch( org.mathrider.piper_me.Piperexception pe )
		{
