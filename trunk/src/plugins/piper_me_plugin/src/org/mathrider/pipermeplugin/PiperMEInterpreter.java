...
import org.mathrider.piper_me.CPiper;
 ...
 */
 ...
 public class PiperMEInterpreter { 

	private static PiperMEInterpreter instance = null;
    ...
    protected PiperMEInterpreter() throws Piperexception {
        ...
        if (!scripts_found) throw new Piperexception ("Piper error: Unable to load piper_me.jar");
			
        piper.Evaluate("Load(\"piperinit.pi\");");
 
    }//end constructor.
	
   public static PiperMEInterpreter getInstance() throws Piperexception{
      if(instance == null) {
         instance = new PiperMEInterpreter();
      }
      return instance;
   }//end method.
   ...
   public java.util.zip.ZipFile getScriptsZip()
   {
    ...
    private boolean loadScripts() {
        ...
        org.mathrider.piper_me.LispStandard.zipFile = scriptsZip;
     ...
     */
    public String evaluate(String input) throws org.mathrider.piper_me.Piperexception {
