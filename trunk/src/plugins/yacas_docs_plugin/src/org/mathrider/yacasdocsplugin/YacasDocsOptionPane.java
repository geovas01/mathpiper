...
public class YacasDocsOptionPane extends AbstractOptionPane implements
		ActionListener {
	...
	public YacasDocsOptionPane() {
		super(YacasDocsPlugin.NAME);
	}

	public void _init() {
		showPath = new JCheckBox(jEdit
				.getProperty(YacasDocsPlugin.OPTION_PREFIX
		...
		JButton pickPath = new JButton(jEdit
				.getProperty(YacasDocsPlugin.OPTION_PREFIX + "choose-file"));
		...
		addComponent(jEdit.getProperty(YacasDocsPlugin.OPTION_PREFIX
				+ "file"), pathPanel);
	...
	public void _save() {
		jEdit.setProperty(YacasDocsPlugin.OPTION_PREFIX + "filepath",
				pathName.getText());
		Font _font = font.getFont();
		jEdit.setProperty(YacasDocsPlugin.OPTION_PREFIX + "font", _font
				.getFamily());
		jEdit.setProperty(YacasDocsPlugin.OPTION_PREFIX + "fontsize", String
				.valueOf(_font.getSize()));
		jEdit.setProperty(YacasDocsPlugin.OPTION_PREFIX + "fontstyle",
				String.valueOf(_font.getStyle()));
		jEdit.setProperty(YacasDocsPlugin.OPTION_PREFIX + "show-filepath",
	...
	static public Font makeFont() {
		int style, size;
		String family = jEdit.getProperty(YacasDocsPlugin.OPTION_PREFIX
				+ "font");
		try {
			size = Integer
					.parseInt(jEdit
